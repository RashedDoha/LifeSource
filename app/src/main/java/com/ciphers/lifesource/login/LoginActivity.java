...
import com.ciphers.lifesource.MainActivity;
...
public class LoginActivity extends BaseActivity {
                ...
                public void onAuthenticationError(FirebaseError firebaseError) {
                    ...
                    switch(firebaseError.getCode())
                    {
                        case FirebaseError.NETWORK_ERROR:
                            Toast.makeText(getApplicationContext(), getResources().getString(R.string.google_error_network_error) + " connectivity lost",
                                    Toast.LENGTH_SHORT).show();
                            break;
                        case FirebaseError.USER_DOES_NOT_EXIST:
                            mEditTextEmailInput.setError("Email not used by anyone!");
                            break;
    ...
    boolean isEmailValid(String email)
    {
        ...
        {
            goodEmail = false;
            if(email.equals("")) mEditTextEmailInput.setError(getResources().getString(R.string.error_cannot_be_empty));
            else mEditTextEmailInput.setError(String.format(getString(R.string.error_invalid_email_not_valid), email));
